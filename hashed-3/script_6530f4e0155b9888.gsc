...
private function function_25b776e2(localclientnum, ti, entnum)
{
	if(!isdefined(self.var_e4102217[ti]) || self.var_e4102217[ti] != entnum)
	{
		...
		var_be788bba remote_missile_target_lockon::function_3b7b386a(localclientnum, entnum);
...
private function function_2ecbc83c(localclientnum, ti, var_3c5beee7)
{
	...
	{
		var_be788bba = level.var_aac98621[ti];
		var_be788bba remote_missile_target_lockon::function_2ecbc83c(localclientnum, var_3c5beee7);
...
private function function_ec2a2906(localclientnum)
{
	...
	for(ti = 0; ti < level.hawk_settings.bundle.var_48e78794; ti++)
	{
		...
		self function_2ecbc83c(localclientnum, ti, 0);
		var_be788bba remote_missile_target_lockon::function_505f092a(localclientnum, 1);
	}
	self.var_89285548 = 1;
}
...
private function function_d53feb8c(localclientnum, targets)
{
	...
	foreach(target in targets)
	{
		...
		if(isdefined(var_be788bba))
		{
			...
			{
				self function_2ecbc83c(localclientnum, ti, var_e06385a3);
				if(var_e06385a3 == 1)
				{
