...
function __init__()
{
	...
	namespace_f551babc::register_challenge(#"hash_29ed25a648820a10", &function_d1de6a85, &function_9e7b3f4d);
}
...
function is_active()
{
	challenge = namespace_f551babc::function_a36e8c38(#"hash_29ed25a648820a10");
