...
function __init__()
{
	clientfield::register("allplayers", "" + #"player_zombie_blood_fx", 1, 1, "int", &function_11993f20, 0, 1);
	...
	level._effect[#"hash_6f60841fcc579afe"] = "maps/zm_escape/fx8_pwr_up_blood";
...
/*
	...
	Flags: Linked
*/
function function_11993f20(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump)
{
	...
	if(newval == 1)
	{
		...
		{
			self.var_ea67fd25[localclientnum][self.var_ea67fd25[localclientnum].size] = util::playfxontag(localclientnum, level._effect[#"hash_6f60841fcc579afe"], self, "j_eyeball_le");
