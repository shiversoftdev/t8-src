...
/*
	...
	Flags: Linked
*/
function function_f3862b9b(b_pause, str_perk, str_result, var_bcd1c2ff)
{
...
function function_eeb3bf92(var_1483b30b)
{
	...
	while(n_time_left > 0)
	{
		...
		{
			self zm_perks::function_13880aa5(self.var_95df0a1b, var_c2093736, #"hash_e58ff2df5bfd9b3");
		}
	}
}
