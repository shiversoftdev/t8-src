...
function init()
{
	...
	level.var_66153d2c = [];
	spawner::function_89a2cd87(#"hash_1bab8a0ba811401e", &function_3f05435f);
...
function function_9c17f532()
{
	...
	for(i = 1; i < var_66f8b97b; i++)
	{
		var_f9a57be7[i] = array::random(var_2eac42a2);
...
/*
	...
	Flags: Linked
*/
function function_65bda766(var_2eac42a2)
{
	...
	while(true)
	{
		foreach(e_player in util::get_active_players())
		{
			...
			if(e_player istouching(var_6b9abaa9))
			{
				e_player.var_93666696 = function_21a3a673(90, 120);
				e_player thread function_12019de1();
				var_85a6dbde = e_player thread function_f72adc9d(var_2eac42a2);
			}
		}
		wait(0.25);
	}
...
{
	var_6b9abaa9 = getent("vol_ww_oracle_cooldown", "targetname");
	self endon(#"disconnect");
	while(self.var_93666696 > 0)
	{
		if(isdefined(var_6b9abaa9) && !self istouching(var_6b9abaa9))
		{
			self.var_93666696--;
		}
		wait(1);
...
function function_f72adc9d(var_258ed83f)
{
	...
	{
		if(var_146c21.var_b1cb5669 === self && !var_146c21 flag::get(#"hash_35c0d9f1ff884fce"))
		{
	...
	foreach(var_146c21 in var_258ed83f)
	{
		if(!isdefined(var_146c21.var_b1cb5669) && !var_146c21 flag::get(#"hash_35c0d9f1ff884fce"))
		{
	...
	foreach(var_146c21 in var_258ed83f)
	{
		if(!var_146c21 flag::get(#"hash_35c0d9f1ff884fce"))
		{
			var_26e0e1ec = self namespace_891c9bac::function_8e0f4696(var_146c21.var_71e93cfb, 0, 1, 9999, 1, 1, 1);
			return 1;
		}
...
function function_95a52218()
{
	...
	var_88706ea7 = self waittill(#"hash_6858bc0ef6a5b4b1");
	if(!(isdefined(var_88706ea7.e_player.var_4bb711cf) && var_88706ea7.e_player.var_4bb711cf))
	{
		var_88706ea7.e_player.var_4bb711cf = 1;
		var_88706ea7.e_player thread namespace_891c9bac::function_a2bd5a0c(#"hash_4763c20dec1c2a7", 0, 1, 9999, 1);
	}
	self.var_2db8b01a = var_88706ea7.var_2db8b01a;
...
function function_5e0885f9()
{
	...
	waitframe(1);
	self notify(#"hash_6858bc0ef6a5b4b1", {#hash_2db8b01a:self, #e_player:var_385703b7.attacker});
}
...
function function_10310ecb()
{
	...
	while(true)
	{
		...
		{
			self dodamage(self.health + 100, self.origin, var_88706ea7.attacker);
		}
	}
}
...
function function_4186be5f()
{
	...
	if(isdefined(var_7283832f) && var_7283832f)
	{
...
{
	var_49679c8c = spawnstruct();
	level.var_d225ea18[var_fc6baa64] = var_49679c8c;
	switch(var_fc6baa64)
	{
		case "light":
		{
...
function function_6ef2b98f(eventstruct)
{
	...
	waitframe(1);
	if(eventstruct.event == "take_weapon" && !self flag::get(#"hash_39a1607d1d9f960b") && (!(isdefined(self.var_7e19c3db) && self.var_7e19c3db)))
	{
...
function on_player_connect()
{
	...
	self flag::init(#"hash_39a1607d1d9f960b");
...
function on_player_damage(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime)
{
	if(idamage >= self.health || level flag::get("round_reset"))
	{
		...
		else if(self flag::get(#"hash_39a1607d1d9f960b"))
		{
			self notify(#"hash_4d89e2bb8e3d1eb3", {#b_success:0});
		}
...
{
	var_a6677eca = self.stub.related_parent;
	var_5805438d = e_player flag::get(#"hash_664c4b8d9b3d0237");
	var_ec420ce1 = var_a6677eca flag::get(#"hash_58c0761173ca055");
	var_41307fc = var_a6677eca flag::get(#"hash_19f136c3e517eb81");
	...
	if(isdefined(e_player.var_780105c1))
	{
		...
		{
			if(isdefined(var_62398796) && var_62398796)
			{
				var_5b85ec96 = 1;
			}
		}
	...
	{
		if(e_player flag::get(#"hash_8cdde8e6a8607f1") && e_player hasweapon(getweapon(#"hash_438bbe9c4a6cb14d")) && var_a6677eca.targetname !== "s_ww_quests_death_box_interact")
		{
			return 0;
		}
		...
		if(var_a6677eca.targetname === "s_ww_quests_death_box_interact")
		{
			...
			if(var_b37a7d1e === var_a6677eca.var_884c4b3a && var_a6677eca flag::get(#"hash_582906087b67b7c6"))
			{
				str_prompt = zm_utility::function_d6046228(#"hash_758d9ac1d50488b4", #"hash_7cf0aaa08ece2918");
				self sethintstringforplayer(e_player, str_prompt);
				return 1;
			}
			if(var_a6677eca flag::get("flag_ww_quests_portal_available"))
			{
				self sethintstringforplayer(e_player, #"hash_309d162d0e1cd1d1");
				return 0;
			}
		}
		if(var_a6677eca.targetname === "s_ww_quests_earth_box_interact")
		{
		...
		if(var_a6677eca.targetname === "s_ww_quests_light_box_interact")
		{
			if(var_b37a7d1e === var_a6677eca.var_884c4b3a && var_a6677eca flag::get(#"hash_582906087b67b7c6"))
			{
		...
		if(var_a6677eca.targetname === "s_ww_quests_air_box_interact")
		{
			if(var_b37a7d1e === var_a6677eca.var_884c4b3a && var_a6677eca flag::get(#"hash_582906087b67b7c6"))
			{
...
function function_37c18ffd(var_fc6baa64)
{
	var_49679c8c = level.var_d225ea18[var_fc6baa64];
	level endon(#"end_game");
	var_49679c8c endon(#"hash_b2b1975ed579dae");
	...
	{
		switch(var_49679c8c.targetname)
		{
			case "death":
			{
...
function function_7bd1fb22(var_fc6baa64, e_player)
{
	...
	e_player thread function_f7cee57d(var_49679c8c);
}
...
*/
private function function_f7cee57d(var_49679c8c)
{
	self endon(#"disconnect");
...
function function_9520e85d(var_fc6baa64)
{
	...
	{
		var_49679c8c notify(#"hash_b2b1975ed579dae");
...
{
	if(isdefined(self.var_6abc5f0e) && self.var_6abc5f0e)
	{
		return;
	}
	self.var_6abc5f0e = 1;
...
/*
	...
	Flags: Linked
*/
function function_89b62137(var_cf71fefc)
{
	self endon(#"disconnect", #"hash_7fe6ca08732b8a1d");
	while(true)
	{
		n_dist = distancesquared(self.origin, var_cf71fefc);
		if(n_dist > 90000)
		{
			self notify(#"hash_7fe6ca08732b8a1d", {#b_success:0});
		}
...
private function function_ab234072(var_cd1844a3)
{
	...
	self.var_18fd25ab[var_cd1844a3].var_a7b08eba = 0;
	...
	if(isdefined(self.var_167b59c7) && isdefined(self.var_167b59c7[var_cd1844a3]))
	{
		...
		self.var_18fd25ab[var_cd1844a3].var_a7b08eba = 1;
...
{
	var_49679c8c = level.var_d225ea18[#"death"];
	var_49679c8c endon(#"hash_ed775f2b113da55");
	var_4a098962 = getent("vol_ww_death_dust_river", "targetname");
	if(e_target istouching(var_4a098962) && isdefined(var_49679c8c.var_39b71b44) && w_weapon === getweapon(#"hash_438bbe9c4a6cb14d") && e_target.archetype === #"zombie" && !isdefined(e_target.var_4fcc6fa6))
	{
		...
		if(var_49679c8c.var_39b71b44 >= 13)
		{
			...
			var_49679c8c flag::set("river_styx_filled");
		}
	}
...
function function_cdbadaff(var_a06d0f4f, var_2d8a1db5, n_time)
{
	...
	while(gettime() <= starttime + int(n_time * 1000))
	{
		...
		self setlightintensity(function_5d783702(var_3af49a86));
		waitframe(1);
	}
...
/*
	...
	Flags: Linked
*/
function function_5d783702(var_3af49a86)
{
	n_base = pow(2, var_3af49a86);
...
{
	if(zm_utility::is_player_valid(e_player, 0, 0) && e_player flag::get(#"hash_8cdde8e6a8607f1") && (!(isdefined(self.var_a7b08eba) && self.var_a7b08eba)))
	{
...
/*
	...
	Flags: Linked
*/
function function_41234931(var_8df3e635 = 0)
{
	...
	if(isdefined(var_8df3e635) && var_8df3e635)
	{
...
function function_b962a4a6(var_542837e6)
{
	...
	while(true)
	{
		...
		var_385703b7 = undefined;
		var_385703b7 = var_53b15557 waittill(#"damage");
		if(var_385703b7.weapon === var_5a0587d4)
		{
			continue;
		}
		self.n_index++;
...
function function_4771e682(var_542837e6)
{
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = level waittill(#"hash_53f322a8c39f79d6");
		if(var_88706ea7.e_entity === var_919d328)
		{
			n_dist = distance(var_88706ea7.player.origin, var_88706ea7.v_position);
			n_time = n_dist / 1500;
			n_time = n_dist / 1500;
			if(n_time >= 0.1)
			{
			...
			wait(n_time);
			self thread function_2a290bb7(var_542837e6, var_88706ea7.v_position, var_88706ea7.player);
		}
	}
}
...
function function_85a789f1()
{
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = level waittill(#"hash_53077f8dc48c9d78");
		if(!var_88706ea7.t_damage === "trig_mirror_damage1")
		{
			return 0;
		}
	}
	for(i = 0; i < 2; i++)
	{
		var_88706ea7 = undefined;
		var_88706ea7 = level waittill(#"hash_53077f8dc48c9d78");
		if(!var_88706ea7.t_damage === "trig_mirror_damage2")
		{
			return 0;
		}
	}
	var_88706ea7 = undefined;
	var_88706ea7 = level waittill(#"hash_53077f8dc48c9d78");
	if(!var_88706ea7.t_damage === "trig_mirror_damage3")
	{
		return 0;
	}
	var_88706ea7 = undefined;
...
function function_9aa74e4(var_542837e6, e_player, str_clientfield)
{
	e_player endon(#"disconnect");
	var_88706ea7 = undefined;
	var_88706ea7 = e_player waittill(#"hash_3f0faacb0cc98a9", #"fake_death");
	if(var_88706ea7._notify == "fake_death")
	{
		var_88706ea7.b_success = 0;
	}
...
function function_9c79eeed(e_player)
{
	...
	{
		if(e_player util::is_player_looking_at(var_a6677eca.origin, 0.9, 1))
		{
			var_bff804cb = var_a6677eca;
			arrayremovevalue(self.var_20a6106d, var_a6677eca);
			break;
		}
	}
...
function function_dbe1d7b8()
{
	...
	if(isdefined(s_loc))
	{
		...
		var_dafa2b89 clientfield::increment("" + #"hash_551f6ae1cc666550");
...
function function_42afccbf(e_target, weapon = level.weaponnone, n_damage)
{
	...
	{
		var_8ba8f5fa = getent("vol_ww_ouranos_cliff", "targetname");
		var_97d203c3 = getent("vol_ww_ouranos_serpent", "targetname");
		var_82dde107 = getent("vol_ww_ouranos_center", "targetname");
		var_82ca6604 = 0;
		if(e_target istouching(var_82dde107))
		{
			var_82ca6604 = 1;
		}
		else if(e_target istouching(var_8ba8f5fa))
		{
			var_82ca6604 = 2;
		}
		else if(e_target istouching(var_97d203c3))
		{
			var_82ca6604 = 3;
		}
		if(var_82ca6604 > 0)
...
function function_479cad97(e_target, var_82ca6604)
{
	...
	var_d5498a47 = var_e71b3cea.origin - self.origin;
	var_d5498a47 = vectornormalize((var_d5498a47[0], var_d5498a47[1], 0));
	if(vectordot(v_to_target, var_d5498a47) > 0.85)
	{
		self namespace_7a119950::ouranos_feather_hit(undefined, var_82ca6604);
	}
}
...
function function_759247cd(str_loc)
{
	...
	if(isdefined(var_e71b3cea.var_688d8a36) && var_e71b3cea.var_688d8a36)
	{
		...
		var_e71b3cea thread function_3a8465cc(self);
...
/*
	...
	Flags: Linked
*/
function function_3a8465cc(e_player)
{
...
function function_6d466962(var_8290a028, var_5bc443f6, var_9bf51af3, e_player = undefined)
{
	...
	if(!isdefined(var_40bb500f.target))
	{
		...
		switch(var_5bc443f6.targetname)
		{
	...
	{
		var_40bb500f thread function_381519d9(var_8290a028, var_9bf51af3, n_max_height, var_5bc443f6);
		var_8290a028 waittill(#"movedone");
...
function function_381519d9(var_8290a028, var_9bf51af3, n_max_height, var_5bc443f6)
{
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = level waittill(#"hash_5e5ca4b57218c535");
		e_player = var_88706ea7.player;
...
function function_dd1c5ae6()
{
	...
	foreach(var_52666e80 in var_1d89b97b)
	{
		...
		var_52666e80 flag::init(#"hash_6281bbe0bfef24a8");
	}
...
function function_68080923(var_52666e80, var_f927d3b3)
{
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = level waittill(#"hash_7841606423d6fe4c");
		v_orig = var_88706ea7.player getweaponmuzzlepoint();
		n_dist = distance(v_orig, var_88706ea7.v_position);
		n_time = n_dist / 1500;
		if(n_time >= 0.05)
		{
			n_time = n_time - 0.05;
		...
		if(var_88706ea7.e_entity === self)
		{
			...
			{
				if(isdefined(var_88706ea7.player) && (!(isdefined(var_88706ea7.player.var_a381a313) && var_88706ea7.player.var_a381a313)))
				{
					var_88706ea7.player.var_a381a313 = 1;
					var_88706ea7.player thread namespace_891c9bac::function_8e0f4696(#"hash_39d30b7d40892c58", 0, 1, 9999, 1, 1);
				}
				else if(isdefined(var_88706ea7.player))
				{
					var_88706ea7.player thread zm_audio::create_and_play_dialog(#"generic", #"response_positive");
				}
...
function function_ac211843(b_failed)
{
	...
	self flag::set(#"hash_6281bbe0bfef24a8");
	var_88706ea7 = undefined;
	var_88706ea7 = self waittill(#"trigger_activated");
	if(isdefined(var_88706ea7.e_who) && (!(isdefined(var_88706ea7.e_who.var_9cf704b7) && var_88706ea7.e_who.var_9cf704b7)))
	{
		var_88706ea7.e_who.var_9cf704b7 = 1;
		var_88706ea7.e_who thread namespace_891c9bac::function_a2bd5a0c(#"hash_379aab9b6f7dc5f4", 0, 1, 9999, 1);
	}
	self flag::clear(#"hash_6281bbe0bfef24a8");
	var_cb2f80a0 hidepart("sprout_base_jnt", "", 1);
	var_88706ea7.e_who.var_52666e80 = self;
	self thread function_41cb93cc(var_88706ea7.e_who);
}
...
function function_1c5aedd8(e_player)
{
	...
	var_49679c8c = level.var_d225ea18[#"earth"];
	var_88706ea7 = undefined;
	var_88706ea7 = e_player waittill(#"hash_2dd4c93df4644d35", #"fake_death");
	callback::function_5a753d97(&function_3462981);
	callback::function_824d206(&function_3b0917e6);
	e_player.var_52666e80 = undefined;
	if(var_88706ea7.str_result === "dropped" || var_88706ea7.str_result === "loadout_changed" || var_88706ea7._notify == "fake_death")
	{
		if(e_player getcurrentweapon() === level.var_3eccc872)
		{
	...
	else if(isdefined(var_88706ea7.str_result === "planted") && var_88706ea7.str_result === "planted")
	{
		e_player takeweapon(level.var_3eccc872);
	...
	if(var_88706ea7.str_result === "loadout_changed" || var_88706ea7._notify == "fake_death")
	{
...
function function_fd3d477c()
{
	...
	if(isdefined(a_trace[#"position"]))
	{
		...
		var_70c01fdc = util::spawn_model("p8_zm_red_gaia_bush_01_sprout_01", v_spawn_pos, (0, 0, 0));
		var_70c01fdc setscale(n_scale);
		while(n_scale > 0.1)
		{
...
function function_4e2445e0()
{
	...
	if(isdefined(var_a1327d58.var_6abc5f0e) && var_a1327d58.var_6abc5f0e)
	{
		return;
	}
...
function function_6161ce9a(e_player)
{
	...
	e_player flag::set(#"hash_39a1607d1d9f960b");
	e_player.var_7881756e = self.targetname;
	self thread function_8ad28be8(e_player);
	self thread function_aea7779d(e_player);
	e_player thread namespace_eaaeba61::function_66d020b0(undefined, undefined, undefined, self.var_9bd3a2c6, self.var_5357def6, undefined, undefined, 1, 0);
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = e_player waittill_timeout(20, #"hash_1b2c21ba7b18dbf9", #"hash_52d2f17ac6d67de2", #"hash_4969a839c4e666dc", #"hash_39bd256a221ddf79", #"death");
	}
	if(isdefined(var_88706ea7) && var_88706ea7._notify === "timeout")
	{
...
function function_aea7779d(e_player)
{
	e_player endon(#"disconnect");
	var_88706ea7 = undefined;
	var_88706ea7 = e_player waittill(#"hash_4d89e2bb8e3d1eb3");
	if(isdefined(var_88706ea7.b_success) && var_88706ea7.b_success)
	{
		...
		e_player namespace_eaaeba61::function_66d020b0(undefined, undefined, undefined, self.var_9bd3a2c6, self.var_ed424981, undefined, undefined, 1, 0);
		if(isdefined(self.var_f172b16e))
		{
			e_player clientfield::set(self.var_f172b16e, 0);
		}
...
/*
	...
	Flags: Linked
*/
function function_4cd29565(var_49679c8c)
{
...
function function_aeaedb3c()
{
	...
	while(true)
	{
		...
		#/
		if(var_88706ea7.weapon == level.var_ce3aa8a8 || var_88706ea7.weapon == level.var_96059a93)
		{
...
function function_8598f0d4(var_88206a50, e_zombie)
{
	...
	if(isdefined(e_zombie.attacker) && isplayer(e_zombie.attacker) || (isdefined(e_zombie.damageinflictor) && isplayer(e_zombie.damageinflictor)))
	{
		...
		{
			if(!isdefined(var_88206a50.var_96f1a1e1) && e_zombie.archetype == #"hash_1bab8a0ba811401e" && e_zombie.var_9fde8624 == str_archetype)
			{
...
{
	var_19a46f39 = struct::get("s_pap_interact", "targetname");
	var_19a46f39.s_teleport = struct::get("s_pap_teleport");
	var_19a46f39 flag::init(#"hash_485aa689b0560341");
...
/*
	...
	Flags: Linked
*/
function function_f53f86f8(e_player, var_19a46f39)
{
	e_player endon(#"disconnect", #"hash_2026d806e71dfad5");
	self thread function_71b48c56(var_19a46f39);
	wait(1);
	...
	self thread function_f2081007(e_player, var_19a46f39);
	e_player thread namespace_eaaeba61::function_66d020b0(undefined, undefined, undefined, self.var_deb1f081, self.var_5357def6, undefined, undefined, 1, 0);
	if(isdefined(self.var_f172b16e))
	{
		e_player clientfield::set(self.var_f172b16e, 1);
	}
...
/*
	...
	Flags: Linked
*/
function function_71b48c56(var_19a46f39)
{
	if(isdefined(self.var_a04ebe57))
	{
	...
	else if(isdefined(self.var_4d50be8e))
	{
		...
		playsoundatposition(#"hash_2545ab11d0e8966a", var_19a46f39.origin);
	}
	...
	else if(isdefined(self.var_4d50be8e))
	{
		...
		playsoundatposition(#"hash_15e7e9734cce421e", var_19a46f39.origin);
	}
	else if(isdefined(self.var_285af63c))
	{
		...
		if(a_ai_spawned.size < self.var_ad816fb3)
		{
			...
			while(true)
			{
				...
				else if(self.targetname === #"light")
				{
					...
					ai_zombie = namespace_75cbf125::function_6249817(1, s_spawn);
					n_wait_time = 2;
				}
...
function function_eeed4f2f(s_spawn_loc)
{
	...
	if(isdefined(ai))
	{
		...
		ai namespace_3fffba66::function_bbaec2fd();
...
/*
	...
	Flags: Linked
*/
function function_f2081007(e_player, var_19a46f39)
{
	e_player endon(#"disconnect");
	var_88706ea7 = undefined;
	var_88706ea7 = e_player waittill(#"hash_2026d806e71dfad5");
	if(isdefined(var_88706ea7.b_success) && var_88706ea7.b_success)
	{
		...
		e_player namespace_eaaeba61::function_66d020b0(undefined, undefined, undefined, undefined, var_19a46f39.s_teleport, undefined, undefined, 1, 0);
		if(isdefined(self.var_f172b16e))
		{
			e_player clientfield::set(self.var_f172b16e, 0);
		}
	...
	e_player namespace_eaaeba61::function_66d020b0(undefined, undefined, undefined, undefined, var_19a46f39.s_teleport, undefined, undefined, 1, 0);
	var_19a46f39 flag::clear(#"hash_485aa689b0560341");
	if(isdefined(self.var_f172b16e))
	{
		e_player clientfield::set(self.var_f172b16e, 0);
	}
...
function function_99b6184()
{
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = level waittill(#"pap_taken");
		var_f75cde38 = var_88706ea7.var_5e879929.item;
		foreach(var_49679c8c in level.var_d225ea18)
		{
...
function function_d0b13de1()
{
	...
	{
		var_88706ea7 = undefined;
		var_88706ea7 = self waittill(#"hash_12922c9c5f12df1");
		var_89a7260e = var_88706ea7.w_current;
...
private function function_63eabd37()
{
	...
	var_88706ea7 = undefined;
	var_88706ea7 = self waittill(#"pap_taken");
	var_eaddb452 = var_88706ea7.var_5e879929.unitrigger_stub.upgrade_weapon;
...
private function function_43a6c665(var_89a7260e)
{
	...
	var_88706ea7 = undefined;
	var_88706ea7 = level waittill(#"pap_timeout");
	if(isdefined(var_88706ea7.e_player))
	{
		var_88706ea7.e_player thread function_841236e4(var_89a7260e, 0);
	}
}
...
function function_318c3039()
{
	/#
		...
		level function_51a8e408(#"air");
		wait(0.5);
		while(var_49679c8c.var_a1327d58.var_6abc5f0e === 1)
		{
			waitframe(1);
		}
		wait(3);
...
function function_233156e3()
{
	/#
		...
		ai_zombie = zombie_utility::spawn_zombie(array::random(level.zombie_spawners), undefined, var_db04a0a4);
		wait(0.25);
...
function function_c4614158()
{
	/#
		...
		var_19a46f39 = struct::get("", "");
		level.players[0] setorigin(var_19a46f39.s_teleport.origin);
		level.players[0] setplayerangles(var_19a46f39.s_teleport.angles);
	#/
}
...
function function_405e6a83()
{
	/#
		...
		var_49679c8c = level.var_d225ea18[#"earth"];
		var_49679c8c thread function_f53f86f8(level.players[0], var_19a46f39);
		wait(7);
		level.players[0] notify(#"hash_2026d806e71dfad5", {#b_success:1});
		level.players[0] setorigin(var_19a46f39.s_teleport.origin);
		level.players[0] setplayerangles(var_19a46f39.s_teleport.angles);
