...
{
	system::register(#"hash_78bf0dc450091c57", &__init__, &__main__, #"hash_549171449df37316");
}
...
{
	if(isdefined(self.var_8921eebf) && self.var_8921eebf)
	{
		return 0;
	}
	if(isplayer(params.eattacker) && params.eattacker infection::function_bf46a7aa())
	{
		return 0;
	}
