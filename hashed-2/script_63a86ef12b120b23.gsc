...
function function_b603ab34(var_a23636f4)
{
	...
	self thread beacon_loop(var_a23636f4, var_4eaa1f4c);
...
{
	self endon_callback(&function_e7e5d6f5, #"beacon_retrieved", #"death");
	self.var_80612bea = 1;
	while(true)
	{
...
/*
	...
	Flags: Linked
*/
function beacon_loop(var_a23636f4, var_4eaa1f4c)
{
