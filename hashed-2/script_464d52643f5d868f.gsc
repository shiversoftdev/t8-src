...
function function_84f1c310()
{
	...
	if(namespace_59ff1d6c::function_901b751c(#"zmpowerstate") == 1 && namespace_59ff1d6c::function_901b751c(#"hash_29004a67830922b6") != 2)
	{
	...
	else if(namespace_59ff1d6c::function_901b751c("zmPowerState") == 2 || namespace_59ff1d6c::function_901b751c(#"hash_29004a67830922b6") == 2)
	{
		var_40762d8a sethintstring(#"");
		var_325be437 sethintstring(#"");
...
function function_7b6777c5(var_564f954b)
{
	...
	foreach(var_adad907f in var_d72fffcc)
	{
		...
		if(isdefined(level.var_2b94ce72) && level.var_2b94ce72)
		{
			...
			e_enemy thread namespace_54386dac::function_7273c33d(var_adad907f);
...
function function_17ccf041()
{
	...
	while(true)
	{
		...
		if(isplayer(var_f9b5a331))
		{
			...
			var_385703b7 = var_f9b5a331 waittill_timeout(n_check_time, #"damage", #"death");
			if(var_385703b7._notify === "death")
			{
				waitframe(1);
				continue;
			}
...
function function_d0392daf()
{
	...
	var_88706ea7 = self waittill(#"damage", #"teleport");
	if(var_88706ea7._notify == "damage")
	{
		level.var_43bca751 = 1;
	}
}
...
function function_993f4add()
{
	...
	var_88706ea7 = undefined;
	var_88706ea7 = self waittill(#"death", #"hash_4ebd4db45f2d673a");
