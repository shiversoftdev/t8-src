...
class class_7da27482 
{
	...
	*/
	...
	{
		return {#outfititems:var_f5c0467b, #hash_665ae20e:var_cfe86a3e, #outfit:var_cf55444c, #characterhead:var_db113baf, #charactertype:var_1d73bad9, #charactermode:_i_mode, #xuid:_xuid};
	}
...
function function_7474681d(local_client_num, session_mode, character_index)
{
	...
	return {#outfititems:outfit_items, #hash_665ae20e:var_17b172ca, #outfit:outfit_index, #characterhead:getequippedheadindexforhero(local_client_num, session_mode), #charactertype:character_index, #charactermode:session_mode};
}
...
function function_3f5625f1(mode, character_index = 1)
{
	...
	return {#outfititems:outfit_items, #hash_665ae20e:0, #outfit:0, #characterhead:0, #charactertype:character_index, #charactermode:mode};
}
